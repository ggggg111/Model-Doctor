...
parser.add_argument(
    "--low_confidence_path", type=str, default="low_confidence_samples",
    help="Directory to save the low confidence images"
)
...
parser.add_argument(
    "--max_confidence", type=float, default=0.8,
    help="Maximum confidence required to save a sample (non-inclusive)"
)
...
def main():
    ...
    low_confidence_path = os.path.join(args.low_confidence_path, dataset, model_name)
    ...
    class_path_dir = os.path.join(low_confidence_path, f"class_")
